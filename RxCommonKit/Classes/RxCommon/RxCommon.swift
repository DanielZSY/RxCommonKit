...
/// 生成随机32位加密字符串
public var kRandomId: String { return "\(Date().timeIntervalSince1970)\(arc4random())\(arc4random())".md5() }
/// 系统语言
...
/// 应用地址
public let kAppUrl: String = "itms-apps://itunes.apple.com/cn/app/id\(RxKey.appId.appleId)"
/// 评分地址
public let kAppRateUrl: String = "itms-apps://itunes.apple.com/app/id\(RxKey.appId.appleId)?action=write-review"
/// 拨打电话
